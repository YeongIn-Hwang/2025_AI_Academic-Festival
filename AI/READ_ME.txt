...
타임 테이블 생성까지 완료했습니다.  뭔가 한게 많아서 정리하기가 애매한데, 일정 사이에 빈 시간대 기준으로 자동으로 타임테이블을 생성하고, 각 일정마다 클래스 구조 선언 완료하였습니다.

일정 내의 클래스 구조에는 위치 정보가 포함되어 있습니다.

일정 짤때 이후 들어올 일정 Type 선택하는 함수와 해당 장소가 운영하는지 여부를 판단하는 함수 같이 선언하였습니다.

간단하게 말해 DQN 적용 전에 필요한 사항을 준비 완료했습니다.
아마 앞으로 과정은 title이 None인 timetable의 위치에서 경로 생성하는 과정을 준비할 것 같습니다.